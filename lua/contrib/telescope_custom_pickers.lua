-- all credit to https://github.com/JoosepAlviste/dotfiles/blob/master/config/nvim/lua/j/plugins/telescope_custom_pickers.lua
...
local read_json_file = require('core.utils').read_json_file
local read_package_json = require('core.utils').read_package_json
local termcode = require('core.utils').termcode
