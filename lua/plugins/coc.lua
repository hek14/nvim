...
M.config = function()
  ...
  keyset("n", "E", show_docs, {silent = true})
  ...
  keyset("x", "uf", "<Plug>(coc-funcobj-i)", opts)
  keyset("o", "uf", "<Plug>(coc-funcobj-i)", opts)
  keyset("x", "af", "<Plug>(coc-funcobj-a)", opts)
  keyset("o", "af", "<Plug>(coc-funcobj-a)", opts)
  keyset("x", "uc", "<Plug>(coc-classobj-i)", opts)
  keyset("o", "uc", "<Plug>(coc-classobj-i)", opts)
