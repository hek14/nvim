...
-- another refer: https://github.com/aroig/dotfiles/blob/master/awesome/abdo/pickle.lua
----------------------------------------------
-- Pickle.lua
...
local profile = function ()
  local t = require('scratch.a_table')
  local start = vim.loop.hrtime()
  local s
  for i = 1,10 do
    s = pickle(t)
  end
  print('pickle spent: ',(vim.loop.hrtime()-start)/1000000/10)
  local ut
  start = vim.loop.hrtime()
  for i = 1,10 do
    ut = unpickle(s)
  end
  print('unpickle spent: ',(vim.loop.hrtime()-start)/1000000/10)
end
