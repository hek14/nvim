...
function M.config()
  ...
  -- vim.diagnostic.config {
    ...
    local on_attach = function(client, bufnr)
      ...
      buf_set_keymap("n", "gd", "<cmd>lua require('plugins.lspconfig').Smart_goto_definition()<CR>",map_opts)
      ...
      -- buf_set_keymap("n", "[r", "<cmd>lua require('plugins.lspconfig').Smart_goto_next_ref(-1)<CR>",map_opts)
      ...
      buf_set_keymap("n", "E", "<cmd>lua require('plugins.lspconfig').show_documentation()<CR>",map_opts)
