-- reference: https://github.com/XXiaoA/nvimrc
local fn = vim.fn
local api = vim.api

local save_dir = fn.stdpath("data")

local nmap = function(...)
  require('core.utils').map('n',...)
end
...
local function edit()
    ...
    api.nvim_open_win(0, true, {
        relative = "win",
        width = math.floor(api.nvim_get_option("columns") * 0.6),
